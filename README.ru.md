...
В настоящее время эффект AC берется с весом 65%, магические сопротивления элементам имеют по 7,5%, сопротивления разума и тела по 2,5%. Эти веса подходят для группы, участвующей в ближнем бою и имеющей вора.
Если вы предпочитаете ловушки, которые взрываются в лицо, и разбираетесь с мобами издалека, то, безусловно, элементальная часть должна иметь большее влияние на результат. Альтернативная конфигурация также включена в файл cmInit.lua.
