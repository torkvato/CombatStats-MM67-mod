...
function sortInventory(all)
	...
	if itemList[1] then
		...
		local alchemy_counter = 0
		vars.alchemyPlayer=vars.alchemyPlayer or -1
		for i=1,#itemList do
			if vars.alchemyPlayer>=0 then
				if table.find(alchemyItemsOrder,itemList[i].Number) or (itemList[i].Number>=220 and itemList[i].Number<300) then
					alchemy_counter = alchemy_counter + 1
					if alchemy_counter > 9*12 then
						Game.CurrentPlayer = vars.alchemyPlayer%Party.High + 1
					else
...
alchemyItemsOrder = {
	...
	200, 1002, 1007, 1012, 1764, 1763, 1762, 201, 1003, 202, 1004, 203, 1005, 204, 1006,
	205,  206, 1008, 207, 1009, 208, 1010, 209, 1011,
	210,  211, 1013, 212, 1014, 213, 1015, 214, 1016	
}
itemEquipStat={
	[1]=0,
	[2]=1,
